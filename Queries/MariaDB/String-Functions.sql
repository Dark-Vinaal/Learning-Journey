...
MariaDB [-]> INSERT INTO Student VALUES (1, 'Alice',   20, 9876543210, 'Computer Science');
Query OK, 1 row affected (0.018 sec)

MariaDB [-]> INSERT INTO Student VALUES (2, 'Bob',     22, 9123456789, 'Mathematics');
Query OK, 1 row affected (0.005 sec)

MariaDB [-]> INSERT INTO Student VALUES (3, 'Charlie', 21, 9988776655, 'Physics');
Query OK, 1 row affected (0.004 sec)

MariaDB [-]> INSERT INTO Student VALUES (4, 'Diana',   23, 9871234560, 'Computer Science');
Query OK, 1 row affected (0.004 sec)

MariaDB [-]> INSERT INTO Student VALUES (5, 'Eve',     20, 9765432100, 'Mathematics');
Query OK, 1 row affected (0.004 sec)
...
MariaDB [-]> SELECT ID, CONCAT(Name, ' - ', Studies) AS Name_Studies FROM Student;
+----+--------------------------+
| ID | Name_Studies             |
+----+--------------------------+
...
MariaDB [-]> SELECT ID, Name, SUBSTRING(Name, 1, 3) AS Short_Name FROM Student;
+----+---------+------------+
| ID | Name    | Short_Name |
+----+---------+------------+
|  1 | Alice   | Ali        |
...
MariaDB [-]> SELECT ID, Name, LENGTH(Name) AS Name_Length FROM Student;
+----+---------+-------------+
| ID | Name    | Name_Length |
+----+---------+-------------+
|  1 | Alice   |           5 |
...
MariaDB [-]> SELECT ID, Name, UPPER(Name) AS Upper_Name FROM Student;
+----+---------+------------+
| ID | Name    | Upper_Name |
+----+---------+------------+
|  1 | Alice   | ALICE      |
...
MariaDB [-]> SELECT ID, Name, LOWER(Name) AS Lower_Name FROM Student;
+----+---------+------------+
| ID | Name    | Lower_Name |
+----+---------+------------+
|  1 | Alice   | alice      |
